...
/**
 * FirstTableController implements the CRUD actions for FirstTable model.
 */
class FirstTableController extends Controller
{
    ...
    {
        $model = new FirstTable(['scenario' => FirstTable::SCENARIO_FIRST]);
//        $model->setScenario();
        ...
        return $this->render('create-scenario', [
            'model' => $model,
        ]);
    }
